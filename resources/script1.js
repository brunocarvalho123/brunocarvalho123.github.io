...
function makePlay(diff, change){
	...
	while(t1<change){
		if(!isHidden(document.getElementById('d1').children[diff].children[t2])){
			document.getElementById('d1').children[diff].children[t2].src="./resources/gem_02.png";
			t1++;
		}
		t2++;
	}
...
function randPlay(){
	...
	while(t1<x2){
		if(!isHidden(document.getElementById('d1').children[rand].children[t2])){
			document.getElementById('d1').children[rand].children[t2].src="./resources/gem_02.png";
			t1++;
		}
		t2++;
	}
